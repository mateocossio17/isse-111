...
costo_producto= 100
peso_envio = 3
origen_del_pedido = 1 #se coloca 1 para pedidos nacionales o 2 para internacionales 
if peso_envio <= 5 :
  costo_envio= 20 
  costo_total= costo_envio + costo_producto
  if origen_del_pedido == 1 :
    costo_descontado = costo_total - (costo_total * 0.10)
    print  ("tu costo es de ", costo_descontado)
  else:
    print("tu costo es de ", costo_total)

elif peso_envio>5 and peso_envio<20:
  costo_envio= 30
  costo_total= costo_envio + costo_producto
  if origen_del_pedido == 1 :
    costo_descontado = costo_total - (costo_total * 0.10)
  ...
  print("solo aceptamos hata 20 kg ")

# digito mas grande de un numero no entendi 
numero= 456322189
...
for letra in num1:
  if (int(letra) > mayor):
     mayor = int(letra) 
print("el dígito mayor es:",str(mayor))
